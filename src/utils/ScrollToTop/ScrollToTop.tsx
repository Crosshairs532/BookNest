  ...
  return (
    <div>
      <div
        ...
        } transition-all duration-1000 arrow  mix-blend-difference left-[90vw] lg:left-[10vw] -translate-x-[50%] -translate-y-[50%]`}
      >
        <span className=" group how_cursor  text-white z-[600]  relative m-0  hidden  rounded-full">
          <div className=" lg:group-hover:scale-100 duration-500 ease-in-out scale-0 z-10 flex justify-center items-center absolute top-0 left-0 rounded-full circle w-full h-full bg-white">
            <small className=" font-plainRegular rotate-[135deg] font-semibold  text-[#0e0e0e]">
              scroll To Top
            </small>
          </div>
          <svg
            className="-rotate-[45deg] w-[10vw] h-[10vw] lg:w-[5vw] lg:h-[5vw] "
            viewBox="0 0 91 118"
            fill="none"
          >
            <path
